...
description: This skill provides reference guidance for citation verification in academic and humanities writing. Use when the user asks about "citation verification best practices", "how to verify references", "preventing fake citations", or needs guidance on citation accuracy across disciplines, including humanities and arts scholarship.
